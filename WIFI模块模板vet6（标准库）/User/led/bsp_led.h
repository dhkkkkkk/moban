...
#define             an1_GPIO_APBxClock_FUN              RCC_APB2PeriphClockCmd
#define             an1_GPIO_CLK                        RCC_APB2Periph_GPIOC
#define             an1_GPIO_PORT                       GPIOC
#define             an1_GPIO_PIN                        GPIO_Pin_8

#define             an2_GPIO_APBxClock_FUN              RCC_APB2PeriphClockCmd
#define             an2_GPIO_CLK                        RCC_APB2Periph_GPIOC
#define             an2_GPIO_PORT                       GPIOC
#define             an2_GPIO_PIN                        GPIO_Pin_9
/****************************** LED 函数宏定义***************************************/
