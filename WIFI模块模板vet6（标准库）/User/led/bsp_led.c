...
{		
  ...
  RCC_APB2PeriphClockCmd ( an1_GPIO_CLK, ENABLE ); 															   
	GPIO_InitStructure.GPIO_Pin = an1_GPIO_PIN;	
	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP;   
	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz; 
	GPIO_Init ( an1_GPIO_PORT, & GPIO_InitStructure );	
	
	RCC_APB2PeriphClockCmd ( an2_GPIO_CLK, ENABLE ); 															   
	GPIO_InitStructure.GPIO_Pin = an2_GPIO_PIN;	
	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP;   
	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz; 
	GPIO_Init ( an2_GPIO_PORT, & GPIO_InitStructure );	
}
